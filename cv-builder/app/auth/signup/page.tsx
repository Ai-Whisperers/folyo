...
export default function SignUpPage() {
  ...
  const getPasswordRequirements = (pwd: string): PasswordRequirement[] => [
    { met: pwd.length >= 6, text: 'At least 6 characters' },
    { met: /[a-z]/.test(pwd), text: 'At least one lowercase letter' },
    { met: /[A-Z]/.test(pwd), text: 'At least one uppercase letter' },
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="max-w-md w-full bg-white p-8 rounded-2xl shadow-xl text-center mx-4">
            ...
            <p className="text-gray-600 mb-4">
              Welcome to Folyo. Redirecting to your dashboard...
            </p>
          ...
          <div className="relative z-10 flex flex-col justify-center px-12 text-white">
            <div className="max-w-md">
              ...
              <p className="text-xl text-teal-100 mb-8">
                Join thousands of professionals who trust Folyo to create stunning portfolios that get results.
              </p>
                  ...
                  <div className="relative">
                    ...
                    >
                      {showPassword ? (
                        ...
                        <EyeIcon className="h-5 h-5 text-gray-400 hover:text-gray-600" />
                      )}
                    </button>
                  </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-11 pr-12 py-3 border rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-colors text-gray-900 ${
